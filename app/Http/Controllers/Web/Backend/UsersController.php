...
namespace VanguardLTE\Http\Controllers\Web\Backend
{
    ...
    class UsersController extends \VanguardLTE\Http\Controllers\Controller
    {
        ...
        public function balanceAdd(\VanguardLTE\User $user, \Illuminate\Http\Request $request)
        {
            $request->merge([
                'user_id' => $user->id,
                'type' => 'add',
                'summ' => $request->summ ?: $request->amount
            ]);
            return $this->updateBalance($request);
        }

        public function balanceOut(\VanguardLTE\User $user, \Illuminate\Http\Request $request)
        {
            $request->merge([
                'user_id' => $user->id,
                'type' => 'out',
