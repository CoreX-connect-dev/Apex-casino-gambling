        ...
        <div class="row w-100 m-0">
            ...
            <div class="col-10 col-sm-6 text-sm-right text-center">
                <div class="btn primary-btn d-inline-block mt-1 user-info">
                    <span class="custom-input-group-icon text-left" style="margin-right: 10px;" data-toggle="tooltip" title="Username">
                        <i class="fas fa-user"></i>
                        <span id="user-username">{{ Auth::user()->username }}</span>
                    </span>
                    <span class="custom-input-group-icon text-left" style="margin: 10px;" id="hideMsg" data-toggle="tooltip" title="Balance">
                    ...
                    <span class="custom-input-group-icon text-left" style="margin-left: 10px;" data-toggle="tooltip" title="Bonus">
            ...
            <div class="d-none d-md-block col-sm-8 p-0 text-center text-sm-left"></div>
            <div class="col-12 col-sm-4 text-right bonuslvl d-none"></div>
        </div>
    </nav>
    <!-- END NAVBAR -->
                ...
                <div>
                    <ul class="navbar-nav">
                        <li class="nav-item" data-category="all">
                            <a class="nav-link text-center" href="javascript: void(0);">All</a>
                        </li>
                        @php
                        $companies = [
                            'wazdan', 'arcade', 'netgame', 'betsoft', 'gdgames',
                            'cq9', 'playgt', 'vision', 'playngo', 'ka-gaming',
                            'mainama', 'skywind', 'pragmatic', 'novomatic', 'netent',
                            'igrosoft', 'greentube', 'casino-technology', 'aristocrat',
                            'amatic', 'playtech', 'gamomat', 'isoftbet', 'egt'
                        ];
                        @endphp
                        @if ($categories && count($categories))
                            @foreach($categories AS $index=>$category)
                                ...
                                <li class="nav-item" data-sv="{{ $category->href }}" data-category="{{ $category->id }}">
                                    <a class="nav-link text-center" href="javascript: void(0);">{{ $category->title }}</a>
                                </li>
                                @endif
                            @endforeach
                        @endif
    ...
    <footer>
        <div class="row m-0">
            <div class="col-12 col-md-3 p-0 border-container">
                ...
                <div class="container">
                    <p class="text-justify">For best performance please make sure you have the latest version of Google Chrome.</p>
                </div>
                <div class="container">
                    <p class="text-justify">All graphic material contained on the website including logos, text, sound, videos, design, photographs are subject to copyright and may not be distributed without explicit written consent of the Casino.</p>
                </div>
            </div>
            <div class="col-12 col-md-3 p-0 border-container">
                ...
                <div class="container text-center">
                    ...
                    <p class="text-justify">
                        ...
                        <br/>Therefore, we offer you only games from reliable and long proven certified suppliers.
                        <br/>We approach to Responsible Gaming and Player Protection.
                    </p>
                </div>
            </div>
            ...
            <div class="col-12 col-md-2 p-0 border-container">
                <h5 class="text-center p-2">Social Media</h5>
                <div class="container text-center"><h6>Follow Us On ...</h6></div>
                <div class="row m-0">
            ...
            <div class="col-12 col-md-2 p-0 border-container">
                ...
                <div class="container mt-5 text-center">
                    <h6>&copy; 2020 the Casino<br/>All Rights Reserved</h6>
                </div>
            </div>
        </div>
    </footer>
...
<!-- BACK TO TOP -->
<a id="back-to-top" href="javascript: void(0);" class="btn primary-btn btn-lg back-to-top" role="button" title="Back to Top" data-toggle="tooltip" data-placement="left">
...
<!-- GAME WINDOW MODAL -->
<div class="modal fade" id="game-window-modal" tabindex="-1" role="dialog" aria-labelledby="game-window-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document" id="game-window-modal-dialog">
        <div class="modal-content" id="game-modal-content">
            <div class="modal-header">
                <a style="z-index: 20;" href="javascript: void(0);" id="game-window-modal-fullscreen" class="modal-button" aria-label="Open in Fullscreen" rel="fullscreen">
                ...
                <button style="z-index: 20;" type="button" class="close modal-button" data-dismiss="modal" aria-label="Close">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            <div id="bonusdiv" style="display: none;">
                <div id="bonusinner"><div id="bonusamount"></div></div>
            </div>
            <div id="jpdiv" style="display:none;">
                <div id="jpinner"><div id="jpwin" class="center2"></div></div>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close modal-button" data-dismiss="modal" aria-label="Close"><i class="fas fa-times"></i></button>
            </div>
            <div class="modal-body p-3">
                <form id="register-form" action="#" method="post">
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-address-card"></i></span>
                        <input id="register-form-first-name" type="text" name="register-form-first-name" placeholder="First Name"/>
                    </div>
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-address-card"></i></span>
                        <input id="register-form-last-name" type="text" name="register-form-last-name" placeholder="Last Name"/>
                    </div>
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-at"></i></span>
                        <input id="register-form-email" type="email" name="register-form-email" placeholder="Email"/>
                    </div>
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-user"></i></span>
                        <input id="register-form-username" type="text" name="register-form-username" placeholder="Username"/>
                    </div>
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-key"></i></span>
                        <input id="register-form-password1" type="password" name="register-form-password1" placeholder="Password"/>
                    </div>
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-key"></i></span>
                        <input id="register-form-password2" type="password" name="register-form-password2" placeholder="Retype Password"/>
                    </div>
                    <button type="submit" form="register-form" value="Submit" class="btn primary-btn w-100 mt-4">Register</button>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body p-3">
                <form id="login-form" action="#" method="post">
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-user"></i></span>
                        <input id="login-form-username" type="text" name="login-form-username" placeholder="Username"/>
                    </div>
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-key"></i></span>
                        <input id="login-form-password" type="password" name="login-form-password" placeholder="Password"/>
                    </div>
                    <button type="submit" form="login-form" value="Submit" class="btn primary-btn w-100 mt-4">Login</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="ticket-modal" tabindex="-1" role="dialog" aria-labelledby="ticket-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ticket-modal-title">Ticket</h5>
                <button type="button" class="close modal-button" data-dismiss="modal" aria-label="Close"><i class="fas fa-times"></i></button>
            </div>
            <div class="modal-body p-3">
                ...
                <form id="ticket-form" action="#" method="post">
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-user"></i></span>
                        <input id="ticket-form-username" type="text" value="{{ Auth::user()->username }}" disabled name="ticket-form-username" placeholder="Username"/>
                    </div>
                    <div class="custom-input-group mb-2">
                        <span class="custom-input-group-icon"><i class="fas fa-money-bill-alt"></i></span>
                        <input id="ticket-form-balance" disabled value="" type="text" name="ticket-form-balance" placeholder="Balance"/>
                    </div>
                    <button type="button" form="ticket-form" id="ticket-print-button" value="Submit" class="btn primary-btn w-100 mt-4">Print</button>
                </form>
            </div>
        </div>
    </div>
...
<!-- HELP MODAL -->
<style>
    .modal-fullscreen .modal-dialog { max-width: 100%; height: 100vh; }
    .modal-full .modal-content { width: 100vw; height: 100%; }
</style>
<div class="modal fade modal-fullscreen" id="help-modal" tabindex="-1" role="dialog" aria-labelledby="help-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-full" role="document">
        <div class="modal-content modal-content-full">
            ...
            <div class="modal-body p-3">
                <h4></h4>
                Online casino is one of the most reliable and proven online casinos. You can enjoy a number of popular games known from land-based casinos all over the world. Players can choose between classic fruit slot games, theme slots, Roulette, Black Jack, Keno and other games including exclusive brand new games.
                <div class="d-none pt-3" id="bonus1">
                    ...
                    <span id="bonus2" class="d-none pt-3">
                        ...
                        Deposit From<br>
                        <span id="dates" class="font-weight-bold text-danger"></span>
                        and get <span id="hp_bonus" class="font-weight-bold text-danger"></span> bonus.
                        Happy hour bonus is an increased cash back bonus at specific time of the day so on every deposit you get
                        <span id="hp_bonus2" class="font-weight-bold text-danger"></span> added to your bonus box.
                        <hr>
                    </span>
                </div>
            </div>
...
<!-- BONUS / LEVEL MODAL -->
<div class="modal fade" id="bonus-modal" tabindex="-1" role="dialog" aria-labelledby="bonus-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-full">
            <div class="modal-header bbbonus1">
                <h5 class="modal-title text-center" id="bonus-modal-title">Lvl</h5>
                <button type="button" class="close modal-button" data-dismiss="modal" aria-label="Close"><i class="fas fa-times"></i></button>
            </div>
            <div class="modal-body p-3 bbbonus1">
                <h1 class="text-center text-warning text-capitalize font-weight-bold">
                    Your level is <span class="lvlspam"></span>
                </h1>
                <div class="text-center">
                    Levels unlock bonus features!<br>
                    Progress is updated every few minutes<br>
                    <div class="pt-5"><h3>* Current level features *</h3></div>
                    <div class="pt-5 msgbonus"></div>
                </div>
            </div>
        </div>
    </div>
</div>
<!-- END BONUS / LEVEL MODAL -->

<!-- CONGRATULATIONS MODAL -->
<div class="modal fade" id="bonus3-modal" tabindex="-1" role="dialog" aria-labelledby="bonus3-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-full">
            <div class="modal-header bbbonus1">
                <h5 class="modal-title text-center" id="bonus3-modal-title">Congratulations!</h5>
                <button type="button" class="close modal-button" data-dismiss="modal" aria-label="Close"><i class="fas fa-times"></i></button>
            </div>
            <div class="modal-body p-3">
                <div class="text-center">
                    <h1 class="modal-title text-center text-warning">Bonus collect!</h1>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    var jackpotSettings = {
        "jackpot-elem1": {
            currentValue: <?php echo isset($jpgs[0]) ? floatval($jpgs[0]->balance) : 0; ?>,
            isRed: false,
            details: {
                bigger_win:     { amount: 100, date: "11-11-2019" },
                number_of_wins: 1,
                last_winner:    { amount: 100, date: "11-11-2019", username: "test" }
            }
        },
        "jackpot-elem2": {
            currentValue: <?php echo isset($jpgs[1]) ? floatval($jpgs[1]->balance) : 0; ?>,
            isRed: true,
            details: {
                bigger_win:     { amount: 100, date: "11-11-2019" },
                number_of_wins: 1,
        ...
        "jackpot-elem3": {
            currentValue: <?php echo isset($jpgs[2]) ? floatval($jpgs[2]->balance) : 0; ?>,
            isRed: false,
            details: {
                bigger_win:     { amount: 100, date: "11-11-2019" },
                number_of_wins: 1,
