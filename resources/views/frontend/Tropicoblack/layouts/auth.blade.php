...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/Tropicoblack/assets/vendors/malihu-custom-scrollbar-plugin/3.15/css/jquery.mCustomScrollbar.min.css') }}"/>
