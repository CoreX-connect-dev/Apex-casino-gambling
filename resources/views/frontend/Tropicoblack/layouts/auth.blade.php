...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/frontend/Tropicoblack/assets/vendors/swiper/4.5.0/css/swiper.min.css"/>
          href="{{ asset('frontend/Tropicoblack/assets/vendors/bootstrap/4.3.1/css/bootstrap.min.css') }}"/>
    ...
    <link rel="stylesheet" type="text/css"
          ...
          href="{{ asset('frontend/Tropicoblack/assets/vendors/odometer/0.4.6/css/odometer-theme-default.css') }}"/>
    <link rel="stylesheet" type="text/css"
          href="/frontend/Tropicoblack/assets/vendors/malihu-custom-scrollbar-plugin/3.15/css/jquery.mCustomScrollbar.min.css"/>
          href="{{ asset('frontend/Tropicoblack/assets/vendors/malihu-custom-scrollbar-plugin/3.15/css/jquery.mCustomScrollbar.min.css') }}"/>
    <link rel="stylesheet" type="text/css"
          href="/frontend/Tropicoblack/assets/vendors/bootstrap-select/1.13.9/css/bootstrap-select.min.css"/>
          href="{{ asset('frontend/Tropicoblack/assets/vendors/bootstrap-select/1.13.9/css/bootstrap-select.min.css') }}"/>
    <link rel="stylesheet" type="text/css"
    ...
    <link rel="stylesheet" type="text/css" href="/frontend/Tropicoblack/assets/css/main-blue.css"/>
          href="{{ asset('frontend/Tropicoblack/assets/vendors/flag-icon-css/3.3.0/css/flag-icon.min.css') }}"/>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/Tropicoblack/assets/css/main-blue.css') }}"/>
...
<script src="/frontend/Tropicoblack/assets/vendors/malihu-custom-scrollbar-plugin/3.15/js/jquery.mCustomScrollbar.concat.min.js"></script>
...
<script src="{{ asset('frontend/Tropicoblack/assets/vendors/malihu-custom-scrollbar-plugin/3.15/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
