...
Route::prefix('V2')->group(function () {
    ...
    // ATM APIs
    Route::post('/atm/ping', 'V2\AtmController@atmPing');

    //=====================
    Route::post('/player/activate', 'V2\AtmController@activateUser');
    Route::post('/player/checkbarcode', 'V2\AtmController@checkBarcodeAsync');
    Route::post('/player/updatebarcode', 'V2\AtmController@saveBarcodeAsync');
    Route::post('/player/deposit', 'V2\AtmController@PendingCashIN');
    Route::post('/player/forgotpassword', 'V2\AtmController@forgotPass');
    Route::post('/player/resetpassword', 'V2\AtmController@resetPass');
    Route::post('/player/checkmagcard', 'V2\AtmController@checkMagCardAsync');
    Route::post('/player/checkpanic', 'V2\AtmController@checkForPanic');
    //Route::post('/player/deposit', 'V2\AtmController@PendingCashIN');

    Route::post('/player/createuservoucher', 'V2\AtmController@createUser');
    Route::post('/atm/updaterec', 'V2\AtmController@updateRecServer');
    Route::post('/player/readcredits', 'V2\AtmController@checkServerCreditsAsync');
    Route::post('/player/deposit', 'V2\AtmController@CashINAsync');
    Route::post('/player/create', 'V2\AtmController@createUserAsync');
    Route::post('/player/createupdatecode', 'V2\AtmController@createUpdateCode');
    Route::post('/player/update', 'V2\AtmController@SaveSettings');
    Route::post('/player/login', 'V2\AtmController@checkSignInAsync');
    Route::post('/player/vouchersignin', 'V2\AtmController@checkVoucherAsync');
    Route::post('/player/createwcode', 'V2\AtmController@createWithdrawCodeAsync');
    Route::post('/player/withdraw', 'V2\AtmController@CashOUTAsync');
});

Route::prefix('V3')->group(function () {
    // Credit relatedAPIs (V3 uses CrudModel more extensively)
    Route::post('/player/depositusb', 'v3\CreditController@creditsDeposit');
    Route::post('/player/withdrawusb', 'v3\CreditController@creditsWithdraw');
    Route::post('/player/withdrawusbcashout', 'v3\CreditController@creditsWithdrawAndCashOut');
    Route::post('/player/withdrawticket', 'v3\CreditController@payoutTicket');
});
